...
public class Java8Compiler2Test extends XtendCompilerTest {
  ...
  @Test
  public void testCase1Before() {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("import java.io.FileReader");
    _builder.newLine();
    _builder.append("import java.util.Set");
    _builder.newLine();
    _builder.append("import static extension com.google.common.io.CharStreams.*");
    _builder.newLine();
    _builder.append("   ");
    _builder.newLine();
    _builder.append("   ");
    ...
    _builder.newLine();
    _builder.append("     ");
    _builder.append("val movies = new FileReader(\'data.csv\').readLines.map [ line |");
    _builder.newLine();
    _builder.append("       ");
    _builder.append("val segments = line.split(\'  \').iterator");
    _builder.newLine();
    _builder.append("       ");
    _builder.append("segments.toSet");
    _builder.newLine();
    _builder.append("     ");
    _builder.append("]");
    _builder.newLine();
    ...
    _builder.newLine();
    StringConcatenation _builder_1 = new StringConcatenation();
    _builder_1.append("import com.google.common.io.CharStreams;");
    _builder_1.newLine();
    ...
    _builder_1.append("@SuppressWarnings(\"all\")");
    _builder_1.newLine();
    _builder_1.append("public class Movies {");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("private final List<Set<String>> movies = new Function0<List<Set<String>>>() {");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("@Override");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public List<Set<String>> apply() {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("try {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("final Function1<String, Set<String>> _function = (String line) -> {");
    _builder_1.newLine();
    _builder_1.append("          ");
    ...
    _builder_1.newLine();
    _builder_1.append("            ");
    _builder_1.append("final Iterator<String> segments = ((List<String>)Conversions.doWrapArray(line.split(\"  \"))).iterator();");
    _builder_1.newLine();
    _builder_1.append("            ");
    _builder_1.append("_xblockexpression = IteratorExtensions.<String>toSet(segments);");
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("List<Set<String>> _map = ListExtensions.<String, Set<String>>map(CharStreams.readLines(new FileReader(\"data.csv\")), _function);");
    _builder_1.newLine();
    _builder_1.append("        ");
  ...
  public void testCase1After() {
    ...
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("private final List<Set<String>> movies = ((Supplier<List<Set<String>>>) () -> {");
    _builder_1.newLine();
    _builder_1.append("  \t\t");
    _builder_1.append("try {");
    _builder_1.newLine();
    _builder_1.append("  \t\t\t");
    _builder_1.append("return ListExtensions.map(CharStreams.readLines(new FileReader(\"data.csv\")), line -> {");
    _builder_1.newLine();
    _builder_1.append("  \t\t\t\t");
    _builder_1.append("return IteratorExtensions.toSet(((List<String>) Conversions.doWrapArray(line.split(\"  \"))).iterator());");
    _builder_1.newLine();
    _builder_1.append("  \t\t\t");
    _builder_1.append("});");
    _builder_1.newLine();
